...
//            StringBuilder rString = new StringBuilder();
//            List<BEPolicy> allowPolicies = polper.retrievePolicies(queriers.get(i),
//                    PolicyConstants.USER_INDIVIDUAL, PolicyConstants.ACTION_ALLOW);
//            GuardPersistor guardPersistor = new GuardPersistor();
//            GuardExp guardExp = guardPersistor.retrieveGuardExpression(queriers.get(i), "user", allowPolicies);
...
//            rString.append(runExpt(GuardExp guardExp, )))
//
//        }
//
//
